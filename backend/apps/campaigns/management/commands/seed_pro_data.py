...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Direct paths in GCS bucket (relative to bucket root)
        gcs_base = "seed_mock/seed_media"
        ...
        campaigns_data = [
            {
                ...
                'status': 'OPEN',
                'cover_image': f"{gcs_base}/covers/gentlewoman_cover.png",
                'brand_logo': f"{gcs_base}/logos/gentlewoman_logo.png"
            },
            {
                ...
                'status': 'OPEN',
                'cover_image': f"{gcs_base}/covers/after_you_cover.png",
                'brand_logo': f"{gcs_base}/logos/after_you_logo.png"
            },
            {
                ...
                'status': 'OPEN',
                'cover_image': f"{gcs_base}/covers/dyson_cover.png",
                'brand_logo': f"{gcs_base}/logos/dyson_logo.png"
            },
            {
                ...
                'status': 'OPEN',
                'cover_image': f"{gcs_base}/covers/grab_cover.png",
                'brand_logo': f"{gcs_base}/logos/grab_logo.png"
            }
        ]
